...
Array.from(document.querySelectorAll('[data-mod]')).forEach(function (mod) {
  mods[mod.dataset.mod](mod);
});

},{"./toggle":2}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var _setModal = function _setModal(args) {
...
var toggle = exports.toggle = function toggle(mod) {
  var trigger = mod.querySelectorAll('[data-toggle-class]');

  if (!trigger) throw new Error('Please provide a trigger using data-toggle-class attribute and state a class to toggle');

  Array.from(trigger).forEach(function (link) {
    var target = document.getElementById(link.dataset.toggleId) || link;
    var isModal = link.dataset.toggleModal !== undefined;
...
},{"core-js/fn/regexp/escape":3,"core-js/shim":326,"regenerator-runtime/runtime":328}],328:[function(require,module,exports){
(function (global){
"use strict";
